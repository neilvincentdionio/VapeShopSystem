...
class ProductModel extends Model
{
    ...
    public function getCategoryOptions(): array
    {
        try {
            ...
            // Table doesn't exist, return default categories
            return self::CATEGORY_OPTIONS;
        }
    }
    ...
    public function getAllProducts($limit = null, $offset = 0)
    {
        try {
            ...
            log_message('error', 'getAllProducts error: ' . $e->getMessage());
            return [];
        }
    }
    ...
    public function countActiveProducts()
    {
        try {
            ...
            log_message('error', 'countActiveProducts error: ' . $e->getMessage());
            return 0;
        }
    }
    ...
    public function countAllProducts()
    {
        try {
            ...
            log_message('error', 'countAllProducts error: ' . $e->getMessage());
            return 0;
        }
    }
    ...
    public function getLowStockProducts($threshold = 10)
    {
        try {
            ...
            log_message('error', 'getLowStockProducts error: ' . $e->getMessage());
            return [];
        }
    }
    ...
    {
        // Use stock column directly from products table since inventory_movements table doesn't exist
        return $this->db->table('products p')
            ->select("p.id, p.category_id, p.name, p.description, p.price, p.image, p.status, p.created_at, p.updated_at, p.stock, 'General' AS category", false);
    }
    ...
    private function createInventoryMovement(
        ...
        try {
            ...
            // Table doesn't exist, just log and return true
            log_message('warning', 'Inventory movements table not found: ' . $e->getMessage());
            return true;
        }
    }
