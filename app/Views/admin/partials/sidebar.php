...
$canManageRoles = function_exists('has_permission') && has_permission('roles.manage');
$canManagePermissions = function_exists('has_permission') && has_permission('permissions.manage');
?>
