...
<head>
    ...
    <title>Create Permission - Quick Puff Vape Shop</title>
    <style>
...
<div class="container">
    ...
    <section class="panel">
        ...
        <form class="form-body" action="<?= site_url('admin/permissions/store') ?>" method="post">
            <?= csrf_field() ?>
            <div class="form-group">
                <label for="name">Permission Name</label>
                <input id="name" type="text" name="name" class="form-control" value="<?= esc((string) old('name')) ?>" placeholder="e.g. activity_logs.manage" required>
                <p class="help-text">Use lowercase letters, numbers, dots, underscores, or hyphens (e.g. feature.action).</p>
            </div>
            <div class="form-group">
                ...
                <select id="module_name" name="module_name" class="form-control">
                    ...
                    <?php foreach (($modules ?? []) as $module): ?>
                        <option value="<?= esc((string) $module) ?>" <?= (string) old('module_name') === (string) $module ? 'selected' : '' ?>><?= esc((string) $module) ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            <div class="form-group">
                <label for="description">Description</label>
                <textarea id="description" name="description" class="form-control" placeholder="Describe what this permission allows..."><?= esc((string) old('description')) ?></textarea>
            </div>
            <div class="actions">
