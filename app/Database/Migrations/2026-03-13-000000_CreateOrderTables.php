    ...
    public function up()
    {
        $this->forge->addField([
            ...
            'total_amount' => [
                ...
                'null'       => false,
                'default'    => 0.00,
                'comment'    => 'Sum of order item subtotals (revenue)',
            ],
            'total_profit' => [
                'type'       => 'DECIMAL',
                'constraint' => '12,2',
                'null'       => false,
                'default'    => 0.00,
                'comment'    => 'Sum of order item profits',
            ],
            'notes' => [
                'type' => 'TEXT',
                'null' => true,
        ...
        $this->forge->addField([
            ...
            'unit_price' => [
                ...
                'null'       => false,
                'default'    => 0.00,
                'comment'    => 'Cost / capital price per unit at time of order',
            ],
            'selling_price' => [
                'type'       => 'DECIMAL',
                'constraint' => '10,2',
                'null'       => false,
                'default'    => 0.00,
                'comment'    => 'Selling price per unit at time of order',
            ],
            'subtotal' => [
                'type'       => 'DECIMAL',
                'constraint' => '12,2',
                'null'       => false,
                'default'    => 0.00,
                'comment'    => 'selling_price x quantity (revenue)',
            ],
            'profit' => [
                'type'       => 'DECIMAL',
                'constraint' => '12,2',
                'null'       => false,
                'default'    => 0.00,
                'comment'    => 'subtotal - (unit_price x quantity)',
            ],
            'created_at' => [
                'type' => 'DATETIME',
                'null' => false,
