...
$routes->post('/rider/returns/dismiss-completed', 'Dashboard::riderDismissCompletedReturns', ['filter' => 'auth:rider']);
$routes->post('/rider/deliveries/dismiss-completed', 'Dashboard::riderDismissCompletedDeliveries', ['filter' => 'auth:rider']);
