...
$routes->group('admin/roles', ['filter' => ['auth:admin', 'permission:roles.manage']], static function ($routes) {
...
$routes->group('admin/permissions', ['filter' => ['auth:admin', 'permission:permissions.manage']], static function ($routes) {
    ...
    $routes->post('delete/(:num)', 'Permissions::delete/$1');
    $routes->get('(:num)', 'Permissions::show/$1');
});
